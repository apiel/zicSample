...
async function main() {
    ...
    const res1 = await fetch("https://freesound.org/apiv2/oauth2/authorize/?client_id=aOE7UaYW68l205T8RHuH&response_type=code", {
      "headers": {
    ...
    const res3 = await fetch("https://freesound.org/apiv2/login/", {
      "headers": {
        ...
        "Referer": "https://freesound.org/apiv2/login/?next=/apiv2/oauth2/authorize/%3Fclient_id%3DaOE7UaYW68l205T8RHuH%26response_type%3Dcode",
    ...
    console.log(`res3 cookies:`, res3.headers.get('Set-Cookie'));
}
main();
